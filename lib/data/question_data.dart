    ...
    questions: {
      ...
      'ac_q2': const FlowQuestion(
        ...
        answers: [
          ...
          FlowAnswer(text: 'No'),
          FlowAnswer(text: 'Not sure', followUpQuestionId: 'ac_b1'),
        ],
      ),
      ...
      'ac_q4': const FlowQuestion(
        ...
        answers: [
          ...
          FlowAnswer(text: 'Not sure', followUpQuestionId: 'ac_b3'),
        ],
      ),
    ...
    questions: {
      ...
      'mfa_q2': const FlowQuestion(
        ...
        answers: [
          ...
          FlowAnswer(text: 'Not sure', followUpQuestionId: 'mfa_b1'),
        ],
      ),
      ...
      'mfa_q3': const FlowQuestion(
        ...
        answers: [
          ...
          FlowAnswer(text: 'No'),
          FlowAnswer(text: 'Not sure', followUpQuestionId: 'mfa_b2'),
        ],
      ),
      ...
      'mfa_q5': const FlowQuestion(
        ...
        answers: [
          ...
          FlowAnswer(text: 'No'),
          FlowAnswer(text: 'Not sure', followUpQuestionId: 'mfa_b3'),
        ],
      ),
